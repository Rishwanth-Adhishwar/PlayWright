...
Expected substring: "Signup / Login"
Received string:    ""
...
```ts
  ...
  26 |     await page.getByText('Proceed To Checkout').click();
  27 |     await expect(page.locator('#cart_items')).toContainText('Place Order');
  28 |     await page.getByRole('link', { name: 'Place Order' }).click();
  29 |     await page.locator('input[name="name_on_card"]').click();
  30 |     await page.locator('input[name="name_on_card"]').fill('funOfBun');
  31 |     await page.locator('input[name="card_number"]').click();
  32 |     await page.locator('input[name="card_number"]').fill('123476548901');
  33 |     await page.getByRole('textbox', { name: 'ex.' }).click();
  34 |     await page.getByRole('textbox', { name: 'ex.' }).fill('441');
  35 |     await page.getByRole('textbox', { name: 'MM' }).click();
  36 |     await page.getByRole('textbox', { name: 'MM' }).fill('03');
  37 |     await page.getByRole('textbox', { name: 'YYYY' }).click();
  38 |     await page.getByRole('textbox', { name: 'YYYY' }).fill('2029');
  39 |     await expect(page.locator('#cart_items')).toContainText('Payment');
  40 |     await page.getByRole('button', { name: 'Pay and Confirm Order' }).click();
  41 |     await expect(page.locator('#form')).toContainText('Order Placed!');
  42 |     await page.getByRole('link', { name: 'Continue' }).click();
  43 |     await page.getByRole('link', { name: ' Logout' }).click();
> 44 |     await expect(page.getByRole('list')).toContainText('Signup / Login');
     |                                          ^ Error: expect(locator).toContainText(expected) failed
  45 | });
```