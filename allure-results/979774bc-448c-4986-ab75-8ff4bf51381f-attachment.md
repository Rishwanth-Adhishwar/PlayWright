...
Locator: locator('p.text-sm.font-semibold.text-cener')
...
Call log:
  ...
  - waiting for locator('p.text-sm.font-semibold.text-cener')
...
```ts
  ...
  16 | 
> 17 |     await expect(page.locator('p.text-sm.font-semibold.text-cener')).toContainText("Rishwanth");
     |                                                                      ^ Error: expect(locator).toContainText(expected) failed
  18 | 
  19 | 
  20 | })
